...
<head>
    ...
    <title>Документация - <?php echo e($version); ?></title>
...
<script>
    window.onload = function() {
        const ui = SwaggerUIBundle({
            dom_id: '#swagger-ui',
            url: "<?php echo route('docs.file', ['version' => $version]); ?>",
            presets: [
...
<?php /**PATH F:\Server\htdocs\RequestsApi\resources\views/docs.blade.php ENDPATH**/ ?>